...
const ATIVOS: ColaboradorAtivo[] = [
  ...
  { nome: 'Fabiana Cristina da Silva Rodrigues', time: 'Equipe Bruno', canal: 'Discadora' },
  ...
  { nome: 'Hana Carolina Pereira do Nascimento', time: 'Equipe Bruno', canal: 'Discadora' },
  { nome: 'Igor Silva dos Santos', time: 'Equipe Bruno', canal: 'Discadora' },
  ...
  { nome: 'Larissa Tayna Silva dos Santos', time: 'Equipe Debora', canal: 'Discadora' },
  ...
  { nome: 'Bianca Fernandes Ferreira', time: 'Equipe Felipe', canal: 'Discadora' },
  { nome: 'Diogo dos Santos Dementino', time: 'Equipe Felipe', canal: 'Discadora' },
  { nome: 'Gabriela Porfirio', time: 'Equipe Felipe', canal: 'Discadora' },
  ...
  { nome: 'Rayssa Oliveira da Silva', time: 'Equipe Felipe', canal: 'Discadora' },
  ...
  { nome: 'Tabata Juliana Ferreira de Lima', time: 'Equipe Felipe', canal: 'Discadora' },
  ...
  { nome: 'Giovana Bueno Silva', time: 'Equipe Ribeirao', canal: 'Discadora' },
  ...
  { nome: 'Thamires Lemos Bernardes Mantello', time: 'Equipe Ribeirao', canal: 'Discadora' },
];
